...
export const proseBody = 'max-w-[65ch] text-pretty text-base leading-prose text-muted';

export const metaText =
  'font-ui text-sm font-medium leading-ui text-meta tabular-nums';

export const accentLink =
  'font-semibold text-accent underline decoration-1 underline-offset-4 outline-none hover:text-accent-hover focus-visible:rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent motion-reduce:transition-none';

export const fieldLabel =
  'font-ui text-sm font-semibold leading-ui text-ink';
